...
public class LoginActivity extends ActionBarActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Paul Edits here to save state on onBackButtonPressed
    ...
    //called to put back text into textviews
    ...
    //saves email and pw given key email and password
...
//                        ((TextView)findViewById(R.id.http_response)).setText(response);
    ...
    public void goToMainPage(String welcome_name){
//        String msg = ((EditText)findViewById(R.id.red_2_green_message)).getText().toString();

        Intent goToIntent = new Intent(this, MainPageActivity.class);

        goToIntent.putExtra("welcome", welcome_name);
